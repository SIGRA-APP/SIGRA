...
@section('content')
    <div class="pd-20 card-box mb-30">
        ...
        <form method="POST" action="{{ url('berita/sukacita/update_berita', $suka_cita->id) }} enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="form-group row">
                <label for="judul" class="col-sm-12 col-md-2 col-form-label">Judul</label>
                <div class="col-sm-12 col-md-10">
                    <input type="text" class="form-control" id="judul" name="judul" value="{{ $suka_cita->judul }}">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input type="date" class="form-control" id="tanggal" name="tanggal"
                        value="{{ $suka_cita->created_at }}">
                </div>
            </div>
            <div class="col-12">
                <label class="form-label"><strong>Detail Berita</strong></label>
                <textarea class="form-control tinymce-editor" name="detail_berita" placeholder="Masukkan detail berita...">{{ $suka_cita->detail_berita }}</textarea>
            </div>
            <div class="form-group row">
