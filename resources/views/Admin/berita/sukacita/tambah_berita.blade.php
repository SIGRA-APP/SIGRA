        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form method="post" action="{{ url('berita/sukacita/insert_berita') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Judul / Keterangan</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" name="judul" placeholder="Berita Suka Cita"
                                    required />
                            </div>
                        </div>
                        <div class="form-group row">
